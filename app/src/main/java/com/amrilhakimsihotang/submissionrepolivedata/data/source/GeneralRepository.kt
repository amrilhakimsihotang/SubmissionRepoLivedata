...
class GeneralRepository private constructor(private val remoteDataSource: RemoteDataSource) :
    GeneralDataSource {
    companion object {
        @Volatile
        private var instance: GeneralRepository? = null

        fun getInstance(remoteDataSource: RemoteDataSource): GeneralRepository =
            instance ?: synchronized(this) {
                instance ?: GeneralRepository(remoteDataSource)
            }
